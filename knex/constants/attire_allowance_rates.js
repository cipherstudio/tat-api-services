    ...
    [
        {
            ...
            "position_group_name": "กลุ่มพนักงานระดับ 6 ขึ้นไป",
          ...
          {
            "assignment_type": "TEMPORARY",
            "position_group_name": "พนักงานซึ่งดำรงตำแหน่งตั้งแต่ระดับ 5 ลงมา หรือลูกจ้าง",
          ...
          },
          {
            ...
            "position_group_name": "พนักงานซึ่งดำรงตำแหน่งตั้งแต่ระดับ 10 ขึ้นไป",
          ...
          {
            "assignment_type": "PERMANENT",
            "position_group_name": "พนักงานซึ่งดำรงตำแหน่งตั้งแต่ระดับ 5 ลงมา",
            "position_name": "C5, C4, C3, C2, C1",
            "level_code_start": 1,
            "level_code_end": 5,
            "destination_type": "B",
          ...
          {
            "assignment_type": "PERMANENT",
            "position_group_name": "พนักงานซึ่งดำรงตำแหน่งตั้งแต่ระดับ 6 จนถึงระดับ 9",
          ...
          {
            "assignment_type": "PERMANENT",
            "position_group_name": "กลุ่มพนักงานระดับ 6-9 และตำแหน่งบริหารบางส่วน",
