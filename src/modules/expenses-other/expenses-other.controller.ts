...
import { ExpensesOtherService } from './expenses-other.service';
...
export class ExpensesOtherController {
  ...
  findAll(
    ...
    @Query('orderBy') orderBy?: ExpensesOtherQueryOptions['orderBy'],
    ...
    const queryOptions: ExpensesOtherQueryOptions = {
      page,
      limit,
      orderBy,
      orderDir,
